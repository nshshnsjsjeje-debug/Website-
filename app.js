...
function openFixedModal(id){const el=$(id);if(!el)return false;el.classList.add('open');return true;}
function closeFixedModal(id){const el=$(id);if(el)el.classList.remove('open');}
...
function openSupportPage(){openFixedModal('supportPageModal');}
