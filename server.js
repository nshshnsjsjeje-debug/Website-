...
app.use(session({secret:process.env.SESSION_SECRET || 'falcon-rp-change-this-secret'||'falcon-secret-change-me',resave:false,saveUninitialized:false,cookie:{httpOnly:true,sameSite:'lax',secure:process.env.NODE_ENV==='production',maxAge:1000*60*60*24*7}}));
