...
app.use(session({secret:process.env.SESSION_SECRET || 'moga-change-this-secret',resave:false,saveUninitialized:false,cookie:{httpOnly:true,sameSite:'lax',secure:process.env.NODE_ENV==='production',maxAge:1000*60*60*24*7}}));
...
app.listen(PORT,()=>console.log(`Moga running on ${PORT}`));
